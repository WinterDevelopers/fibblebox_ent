...
urlpatterns = [
    ...
    path('check-poll-name/', views.checkPollName, name="check-poll-name"),
    path('create-payment/', views.getPaymentRef, name='create-payment-ref'),
    path('create-poll/', views.CreatePoll.as_view(), name="create-poll"),
    ...
    path('generate-poll-payment/', views.generatePollPayment, name="generate-poll-payment"),
    path('poll-payment-verification/<slug:ref>', views.verifyPollPayment, name="verify-poll-payment"),
]